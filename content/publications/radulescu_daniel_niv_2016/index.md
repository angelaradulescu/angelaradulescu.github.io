...
It is unknown how healthy aging changes how people combine everyday learning from outcomes with selective attention when a task is cognitively demanding. We compared younger and older adults in two experiments where only one visual dimension really predicted reward and participants had to discover the best feature by trial and error—sometimes the display was busier, and sometimes we gave hints about what to focus on. Both age groups behaved like reinforcement learners who use attention to narrow the world, but modeling suggested older adults applied a *tighter* filter (updating beliefs about fewer features at once), which may be an adaptive response — and that strategic difference helped account for when older adults were less accurate.
